...
class MyWindow(ctk.CTk):
    def __init__(self, db_quiz, db_sample_mflix):
        ...
        self.button_clear_collection = ctk.CTkButton(self.frame_clear_collection, text="Clear collection",
        ...
        self.button_add_collection = ctk.CTkButton(self.frame_add_collection, text="Add collection",
